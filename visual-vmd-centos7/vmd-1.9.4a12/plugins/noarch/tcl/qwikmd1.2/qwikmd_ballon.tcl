#
# $Id: qwikmd_ballon.tcl,v 1.10 2017/10/24 20:54:20 jribeiro Exp $
#
#==============================================================================
...
proc QWIKMD::ignoreForcesIMD {} {

    set text "Discard any IMD Interactive Forces"
...
proc QWIKMD::energyElectrostatic {} {
    set text "Plot Electrostatic energy"
    return $text
}
...
proc QWIKMD::colorScheme {} {
    set text "Change color scheme"
    return $text
}

proc QWIKMD::renderResBL {} {
    set text "Image resolution/size"
    return $text
}

proc QWIKMD::renderRendBL {} {

    set text "Material Resolution
