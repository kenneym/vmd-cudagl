...
##         
##
## $Id: structurecheck.tcl,v 1.9 2017/09/08 19:49:17 jribeiro Exp $
##


package provide structurecheck 1.1
...
proc StrctCheck::ramacheck {molid selText} {
    ...
    if {$totalresidue > 0} {
        ...
        if {[catch {torsionplot -cmd -molid $molid -seltext ${selText}} error] == 0} {
...
proc StrctCheck::strctcheck { args } {
    ...
    ####Check Chirality
    if {$qwikmd} {}
    ## use the user defined field to select the atoms.
    ## It reduces the size of the text of selection to be parsed
    ## in the chirality and cispeptide functions
    set selAtm [atomselect $molid $selText]
    set userall [$selAtm get user4]
    $selAtm set user4 -9999
    set selText "user4 == -9999"
